...
# Lista de municípios para serem usados como fallback quando não disponíveis na API
MUNICIPIOS_FALLBACK = MUNICIPIOS_SP

# Dicionário com dados reais de referência para alguns municípios (PIB per capita real)
