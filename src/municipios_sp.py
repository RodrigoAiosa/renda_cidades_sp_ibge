"""
Lista completa dos 645 municípios do Estado de São Paulo
...
MUNICIPIOS_SP = [
    ...
    'Borá', 'Boracéia', 'Borborema', 'Borebi', 'Botucatu',
...
# Dicionário com dados reais de referência (PIB per capita e população)
DADOS_REAIS_REFERENCIA = {
    ...
    'Adamantina': {'pib_per_capita': 35000, 'populacao': 34687},
...
def get_municipios_ordenados():
    """Retorna lista de municípios ordenada alfabeticamente"""
    return sorted(MUNICIPIOS_SP)

def get_municipios_sugeridos():
    """Retorna lista de municípios sugeridos (principais cidades)"""
    principais = [
        'São Paulo', 'Campinas', 'São Bernardo do Campo', 'São Caetano do Sul',
        'Santos', 'Ribeirão Preto', 'Sorocaba', 'Jundiaí', 'Barueri', 'Osasco',
        'Santo André', 'São José dos Campos', 'Piracicaba', 'São José do Rio Preto',
        'Presidente Prudente', 'Bauru', 'Marília', 'Araraquara', 'Taubaté',
        'Franca', 'São Carlos', 'Limeira', 'Mogi das Cruzes', 'Sumaré', 'Indaiatuba'
    ]
